import { logLightIcons, logDarkIcons } from "../data/dark-light-mode.js";
...
checkbox.addEventListener('change', () => 
{
 if (checkbox.checked) 
 {
  ...
  logLightIcons(logIcon, homeIcon, vacantIcon, mapIcon);
...
logDarkIcons(logIcon, homeIcon, vacantIcon, mapIcon);
 }
});
