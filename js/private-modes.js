import { privateLightIcons, privateDarkIcons } from "../data/dark-light-mode.js";
...
checkbox.addEventListener('change', () => 
{
 if (checkbox.checked) 
 {
  ...
  privateLightIcons(logIcon, homeIcon, vacantIcon, mapIcon);
...
privateDarkIcons(logIcon, homeIcon, vacantIcon, mapIcon);
 }
});
